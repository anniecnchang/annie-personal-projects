...
def add_data_for_name(name_data, year, rank, name):
    ...
    if name in name_data:
        # in case the same name for boys and girls with different ranking, sub with higher ranking
...
def add_file(name_data, filename):
    ...
    with open(filename, 'r') as f:
        ...
        for line in f:
            ...
            # first line indicates the year
            if num == 0:
                year = line_data[0].strip()
                num = 1
            else:
                rank = line_data[0].strip()
                name1 = line_data[1].strip()
                name2 = line_data[2].strip()
