...
| <img src="https://github.com/anniecnchang/annie-personal-projects/blob/main/data-analysis/data_warehouse.png" alt="Alt text" width="18" height="18"> [Data Warehousing & Analytics]
(https://github.com/anniecnchang/sql-data-warehouse-project) | SQL, ETL, Data Warehousing | This project covers building a data warehouse and turning the data into useful insights. It shows how to put data engineering and analytics best practices into action in a real-world setting. |
